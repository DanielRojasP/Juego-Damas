...
void Estrategia::modoFacil(char tb[][8])
{
...
void Estrategia::modoDificil(char tb[][8])
{
	for (int i = 0; i < 8; i++)
	{
		for (int j = 0; j < 8; j++)
...
void Estrategia::modoAleatorio(char tb[][8])
{
	srand(time(NULL));
...
int Estrategia::getEstado()
{
	return estado;
}

void Estrategia::setEstado(int a)
{
	this->estado = a;
}
